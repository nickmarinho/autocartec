		...
		$(function() {
			$("#btn-submit").click(function() {
				...
				if(name == '' || email == '' || message == '') {
					...
					$('.error').html('Por favor preencha os campos corretamente para enviar sua mensagem.');
					$('.error').fadeIn(1000).fadeOut(7000);
				} else {
					$.ajax({
						type: "POST",
						...
						success: function(){
							$(".colorlib-loader").fadeOut(1000);
							$('.success').fadeIn(1000).fadeOut(7000);
						}
					});
				}
